...
import com.etidevcode.cruddemo.entity.*;
...
public class Application {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		// create a course
		Course tempCourse = new Course("Pacman - How To Course One Million Points");

		// create the students
		Student tempStudent1 = new Student("John", "Doe", "john@luv2code.com");
		Student tempStudent2 = new Student("Mary", "Public", "mary@luv2code.com");
		Student tempStudent3 = new Student("Caroline", "LY", "caroline@luv2code.com");
	...
	private void createInstructorWithCourses(AppDAO appDAO) {
		...
		Instructor tempInstructor =
				new Instructor("Susan", "Public", "susan.public@uv2code.com");
